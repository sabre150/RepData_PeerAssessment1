...
The mean of total steps per day is `r dailyMean`.  
The median of total steps per day is `r dailyMedian`.
...
numNA
```
The number of NA values in the steps column is `r numNA`  
...
- With NA values:       `r as.integer(dailyMean)`  
- With imputed values:  `r as.integer(impMean)`  
  
Median total steps per day.  
- With NA values:       `r as.integer(dailyMedian)`  
- With imputed values:  `r as.integer(impMedian)` 
...
```{r plotDayType, fig.width = 15, fig.height = 15}
